...
chrome.runtime.onInstalled.addListener(function (details) {
  ...
  if (details.reason == 'install' || details.reason == 'update') {
    ...
    chrome.storage.sync.set({
      purposes: [false, false, false, false, false, false, false, false, false, false],
      nextupdate: newDate.toISOString()
    });
    chrome.storage.local.set({
      userlist: {
        "Description": "For users to allow sites"
      } // why provide this??
    });

    updateList();
    var url = chrome.extension.getURL('install-page1.html');
    chrome.tabs.create({
      'url': url
    });
  }
...
function _checkUpdate() {
  _checkUpdate = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee() {
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            chrome.storage.sync.get(['nextupdate'], function (result) {
              var currentDate = new Date();
              var updateDate = Date.parse(result.nextupdate);
...
function _updateList() {
  _updateList = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee2() {
...
/******/ })()
;
//# sourceMappingURL=background-bundle-debug.js.map